...
<%@ include file="../include/headerfooter/header.jsp"%>
	...
	<div id="dtbox">
		...
		<div id="imgplace">
			<div id="main_img1">
				<img
					src="/images/RestImages/${RestVO.R_KIND }/${RestVO.R_NAME}/${ImagesVO.R_IMG}"
					height="auto" width="500">
			</div>
			<div id="main_img2">
				<img
					src="/images/RestImages/${RestVO.R_KIND }/${RestVO.R_NAME }/${ImagesVO.M_IMG}"
					height="600" width="auto">
			</div>
			<!-- 임시 -->
			<div id="main_img3">
				<img
					src="/images/RestImages/${RestVO.R_KIND }/${RestVO.R_NAME }/${ImagesVO.S_IMG}"
					height="600" width="auto">
			</div>
		</div>
					...
					<table style="margin: 0 auto;">
						<tr>
							<td align="center" width="150">
								<a href='reserveForm?rseq=${RestVO.RSEQ }'>
									<img src="/images/icon/reserve.png" height="100">
								</a>
								<div style="height: 10px; width: 100%;"></div>
							</td>
							<td align="center" width="150"><c:choose>
									...
									<c:otherwise>
										<a
											href='addWish?rseq=${RestVO.RSEQ }&kind=${RestVO.R_KIND }'><img
											src="/images/icon/wish.png" height="100"></a>
									</c:otherwise>
								</c:choose>
								<div style="height: 10px; width: 100%;"></div></td>
							<td align="center" width="150"><img src="/images/icon/star.png"
								height="100">
								<div style="height: 10px; width: 100%;"></div></td>
						</tr>
						<tr>
							<td align="center">예약하기</td>
							<td align="center" width="150" style="font-size: 95%;"><c:choose>
									<c:when test="${WishVO.result=='2' }">
							위시리스트에서 빼기
						</c:when>
									<c:otherwise>
				...
				<div style="height: 20px; width: 100%;"></div>
					<div id="detail_2">
						...
						<div>
							...
							<div id="menu_box2" style="text-align:center;"><span style="color:gray;">.................</span></div>
		...
		<form method="post" name="editForm">
			<div class="blank3">
				...
				<div id="moreReview"><input type="button" onclick="location.href='moreReview?rseq=${RestVO.RSEQ}'" value="이 식당의 다른 리뷰 보러가기" id="selector3"></div>
			</div>
		</form>
		...
		<div class="blank4">
			...
			<c:forEach items="${restKindList}" var="kList" begin="0" end="8"
				...
				<div class="minidiv">
					...
					<div class="minidiv1">
						<a
							href="detailForm&rseq=${kList.RSEQ}&kind=${kList.R_KIND}">

							<img
							src="/images/RestImages/${kList.R_KIND }/${kList.R_NAME}/${kList.M_IMAGE}"
