...
<article>
	...
	<input id="restUpdate" type="button" value="식당 정보 수정" onClick="location.href='myRestUpdateForm?rseq=${restVO.rseq}'">
	<input id="go_list" type="button" value="삭제" onClick="location.href='myDeleteRest?rseq=${restVO.rseq}'"> 
	<input id="newCheck" type="button" value="예약대기리스트" onClick="location.href='getNewCheck?rseq=${restVO.rseq}&second=2'">
	<input id="completeCheck" type="button" value="예약확정리스트" onClick="location.href='getCompleteCheck?rseq=${restVO.rseq}&second=2'">
	</form>
</article>
