...
<article>
	<form name="frm" method="post" id="formList">
		<table id="list">
			...
			<tr><th>식당 이미지</th><td height="300" colspan="3"><img src = "/images/RestImages/${imagesVO.r_img }" height="200"></td></tr> 
			<tr><th>대표메뉴 이미지</th><td height="300" colspan="3"><img src = "/images/RestImages/${imagesVO.m_img }" height="200"></td></tr> 
			<tr><th>추가 이미지</th><td height="300" colspan="3"><img src = "/images/RestImages/${imagesVO.s_img }" height="200"></td></tr>  
		</table>
		<input id="rest_save" type="button" value="수정" onClick="location.href='adminRestUpdateForm?rseq=${restVO.rseq}'">   
		<input id="go_list" type="button" value="삭제" onClick="location.href='adminDeleteRest?rseq=${restVO.rseq}'">        
		<input id="go_list" type="button" value="목록" onClick="location.href='adminRestList'">
	</form>
</article>
