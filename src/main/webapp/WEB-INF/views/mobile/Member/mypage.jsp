...
<div id="mypage">
	...
	<div id="rightmypage1">
		<div id= "change">
			...
			<br><br>프로필 이름을 변경합니다.<br><br><br>
			<form method="post" name="frm" action="MchangeName">
		...
		<br>
			...
			<br><br>성별을 변경합니다.<br><br><br>
			<form method="post" name="frm" action="MchangeGender">
		...
		<br>
			...
			<br><br>전화번호를 변경합니다.<br><br><br>
			<form method="post" name="frm" action="MchangePhone">
		...
		<br>
			...
			<br><br>비밀번호를 변경합니다.<br><br><br>
			<form method="post" name="frm" action="MchangePwd">
		...
		<div id="deleteAccount">
			<a href="MdeleteAccountForm"> 회원탈퇴하기 </a>
		</div>
