...
<div id="dtbox">
				...
				<table style="margin: 0 auto;">
					<tr>
						<td align="center" width="200"><a
							href='MreserveForm?rseq=${RestVO.RSEQ }'> <img
						...
						<td align="center" width="200"><c:choose>
								...
								<c:otherwise>
									<a href='MaddWish?rseq=${RestVO.RSEQ }&kind=${RestVO.R_KIND }'><img
					...
					<tr>
						<td align="center" width="200"><img
							...
							<div style="height: 10px; width: 100%;"></div></td>
						<td align="center" width="200"><a
							href='MrestQna?rseq=${RestVO.RSEQ }&r_name=${RestVO.R_NAME }'><img
	...
	<div style="height: 50px; width: 100%;"></div>
	<!--  리뷰 작성 -->
	<form method="post" action="MreviewSubmit?kind=${RestVO.R_KIND }"
		name="reviewForm">
		<div class="blank2">
	...
	<form method="post" name="editForm">
		<div class="blank3">
			...
			<div id="moreReview">
				<input type="button"
					onclick="location.href='MmoreReview?rseq=${RestVO.RSEQ}'"
	...
	<div class="blank4">
		...
		<c:forEach items="${restKindList}" var="kList" begin="0" end="8"
			...
			<div class="minidiv">
				...
				<div class="minidiv1">
					<a href="MdetailForm?rseq=${kList.RSEQ}&kind=${kList.R_KIND}"> <img
