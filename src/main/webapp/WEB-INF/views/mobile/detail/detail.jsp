...
<%@ include file="../include/header.jsp"%>
	...
	<div id="dtbox">
					...
					<table style="margin: 0 auto;">
						<tr>
							<td align="center" width="150">
								<a href='MreserveForm?rseq=${RestVO.RSEQ }'>
							...
							<td align="center" width="150"><c:choose>
									<c:when test="${WishVO.result=='2' }">
										<a
											href='MremoveWish?wseq=${WishVO.wseq }&rseq=${RestVO.RSEQ }&kind=${RestVO.R_KIND }'><img
											src="/images/icon/wish2.png" height="100"></a>
									</c:when>
									<c:otherwise>
										<a
											href='MaddWish?rseq=${RestVO.RSEQ }&kind=${RestVO.R_KIND }'><img
		...
		<div id="box2">
			...
			<div id="location">
				<table>
					...
					<tr>
						<td><a href="Mcategory?kind=${RestVO.R_KIND }">${RestVO.R_KIND }</a></td>
					</tr>
					<tr>
						<th>상호</th>
					</tr>
		...
		<!--  리뷰 작성 -->
		<form method="post"
			action="MreviewSubmit?kind=${RestVO.R_KIND }"
			name="MreviewForm">
			<div class="blank2">
		...
		<form method="post" name="editForm">
			<div class="blank3">
				...
				<div id="moreReview"><input type="button" onclick="location.href='MmoreReview?rseq=${RestVO.RSEQ}'" value="이 식당의 다른 리뷰 보러가기" id="selector3"></div>
			</div>
		</form>
			...
			<c:forEach items="${restKindList}" var="kList" begin="0" end="8"
				...
				<div class="minidiv">
					<div class="minidiv2" style="cursor: pointer;"
						onclick="location.href='MdetailForm?rseq=${kList.RSEQ}&kind=${kList.R_KIND}'">${kList.R_NAME}
					</div>
					<div class="minidiv1">
						<a
							href="MdetailForm&rseq=${kList.RSEQ}&kind=${kList.R_KIND}">
